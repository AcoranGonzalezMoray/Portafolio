  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.contact-link-about').on('click',function(){
     ...
     $('.home-link').on('click',function(){
      gsap.to('.algoritmo-project',.5,{scale:.9});
      gsap.to('.algoritmo-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.algoritmo-project',0,{display:'none',delay:.7});
      gsap.to('.software-project',.5,{scale:.9});
      gsap.to('.software-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.software-project',0,{display:'none',delay:.7});
      gsap.to('.ia-project',.5,{scale:.9});
      gsap.to('.ia-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.ia-project',0,{display:'none',delay:.7});
      gsap.to('.app-project',.5,{scale:.9});
      gsap.to('.app-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.app-project',0,{display:'none',delay:.7});
      gsap.to('.web-project',.5,{scale:.9});
      gsap.to('.web-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.web-project',0,{display:'none',delay:.7});
      gsap.to('#about',.5,{scale:.9});
      gsap.to('#about',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#about',0,{display:'none',delay:.7});
    ...
    $('.web-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.web-project',0,{display:'block',delay:.7})
      gsap.to('.web-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.app-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.app-project',0,{display:'block',delay:.7})
      gsap.to('.app-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.ia-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.ia-project',0,{display:'block',delay:.7})
      gsap.to('.ia-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.software-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.software-project',0,{display:'block',delay:.7})
      gsap.to('.software-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.algoritmo-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.algoritmo-project',0,{display:'block',delay:.7})
      gsap.to('.algoritmo-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    ...
    $('.software-close').on('click',function(){
      gsap.to('.software-project',.5,{scale:.9});
      gsap.to('.software-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.software-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
    ...
    $('.algoritmo-close').on('click',function(){
      gsap.to('.algoritmo-project',.5,{scale:.9});
      gsap.to('.algoritmo-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.algoritmo-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
